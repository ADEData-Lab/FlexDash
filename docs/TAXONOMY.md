...
| Go | Octopus | Off-peak EV charging |
| Cosy | Octopus | Heat pump optimised |
| Intelligent | Various | Smart charging integration |

## Field Mappings

When ingesting data, the following terms are mapped to standard taxonomy:
